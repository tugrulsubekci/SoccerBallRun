...
public class ReviveButton : MonoBehaviour, IUnityAdsLoadListener, IUnityAdsShowListener
{
    ...
    public virtual void OnUnityAdsShowComplete(string adUnitId, UnityAdsShowCompletionState showCompletionState)
    {
        if (adUnitId.Equals(_adUnitId) && showCompletionState.Equals(UnityAdsShowCompletionState.COMPLETED))
        {
            ...
            AdsInitializer.Instance.playerPos = player.transform.position;
            AdsInitializer.Instance.isRevived = true;
            AdsInitializer.Instance.reviveCoins = gameManager._coins;
